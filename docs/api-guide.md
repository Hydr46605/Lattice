...
Use `compileOnly("io.github.hydr46605:lattice-paper:0.8.4")` for shared-runtime Paper plugins. Use `implementation("io.github.hydr46605:lattice-paper:0.8.4")` only for legacy isolated jars that intentionally shade Lattice.
